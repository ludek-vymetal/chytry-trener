...
class RoleSelectScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<RoleSelectScreen> createState() =>
      _RoleSelectScreenState();
}
...
class _RoleSelectScreenState
  ...
  void _openPaywall(
    ...
    PaywallTarget target,
  ) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => PaywallScreen(target: target),
      ),
    );
  }
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              if (currentLocale?.languageCode == 'cs') {
                ...
                localeNotifier.state = const Locale('cs');
              }
            },
          ),
              ...
              child: Padding(
                ...
                child: subAsync.when(
                  ...
                  data: (sub) {
                    ...
                    final clientLocked =
                        !active || !sub.clientUnlocked;

                    final coachLocked =
                        !active || !sub.coachUnlocked;
                    ...
                    String statusText() {
                      ...
                      if (sub.coachUnlocked) {
                        return l10n.activeCoachClient;
                      }

                      if (sub.clientUnlocked) {
                        return l10n.activeClientCoachLocked;
                      }
